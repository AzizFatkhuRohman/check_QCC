...
<body>
    <style>
        body {
            ...
            /* Menjaga gambar tetap pada tempatnya saat scroll */
        }
    </style>
    <main>
        <div class="container">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3" style="width: 30rem">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Reset Password Anda</h5>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="email"
                                                class=" col-form-label text-md-end">{{ __('Alamat Email') }}</label>
